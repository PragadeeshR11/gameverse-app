...
import { ExplrLayout } from '../src/UI/Layouts.jsx';
import Categories from '../src/componenets/Categories.jsx';
import { useEffect, useState, useRef, use } from 'react';
import { ActiveSecCntxt } from '../src/context/ActiveSection.jsx';
import useActiveNav from '../src/hooks/useActiveNav.js';
        ...
        <div className="lg:hidden px-3 sm:px-4 py-6 sm:py-8 space-y-8 sm:space-y-12">
          {exploreItems.map((item, i) => (
            <div key={i} className=" border border-white/10 rounded-xl overflow-hidden bg-white/2">
              ...
              <div className="p-5">
                <h3 className="text-xl sm:text-2xl font-medium text-[#dee2e6] mb-2 sm:mb-3">
                  {item.title}
                </h3>
