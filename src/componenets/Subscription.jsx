...
export default function Subsription() {
  ...
  return (
    <section ref={secRef} id="subscriptions" className="pb-16 sm:pb-24 scroll-mt-18 px-2 sm:px-0">
      <SubLayout>
        ...
        <div className="relative w-[180px] flex p-1 mx-auto mt-6 lg:absolute lg:right-16 xl:right-24 lg:top-8 border border-pink-100 rounded-full">
          <div
          ...
          <button
            type="button"
            className={`relative z-10 w-1/2 px-2.5 py-0.5 rounded-2xl text-sm
