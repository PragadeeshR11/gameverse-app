            ...
            <div className="header w-screen my-8  grid grid-cols-[0.75fr_3fr_0.75fr] items-center">
                ...
                <div className='auth text-lg font-light text-[#868e96] justify-self-start'>
                    <ul className='flex gap-3'>
                        <button>Login</button>
                        <button className='signup bg-amber-50 text-[#212529] px-2 py-0.5 font-normal rounded-2xl'>Sign up</button>
                    </ul>
                </div>
            </div>
            <div className="title text-center">
                <h2 className="audiowide text-9xl mt-48 mb-8 drop-shadow-[0_0_15px_rgba(168,85,247,0.4)]">Gameverse</h2>
                <p className='text-xl font-thin text-gray-400 tracking-wider'>Interactive interface for discovering and exploring games</p>
