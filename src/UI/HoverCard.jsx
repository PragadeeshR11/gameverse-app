export default function HoverCard({ genre }) {
  ...
  return (
    <div className="hoverCard group perspective w-full h-[240px]">
      <div
        className="relative w-full h-full bg-[linear-gradient(135deg,#0b020b,#140514,#1a071c)] border border-gray-700/60 shadow-[inset_0_0_0.5px_rgba(255,255,255,0.1)] rounded-lg 
      ...
      >
        ...
        <div className="cardFront absolute inset-0 flex justify-self-center backface-hidden overflow-hidden ">
          <Icon className="w-12 h-auto opacity-80 text-gray-300 transition-all duration-300" />
        </div>

        <div
          className="cardRear absolute inset-0 rounded-lg  border border-[#ff2d75] shadow-[0_0_10px_rgba(255,45,117,0.6)] 
